...
IF(ISSET($_GET['searchlabno'])){
	...
	echo "<br>SEARCH RESULTS<hr>";
	
	if($search_count>0){
		
		//echo "<table class='table-condensed table-bordered table'>
		echo "<table class='table-bordered'>
		<tr><th>OPTIONS</t><th>FREEZER</th><th>CHEST</th><th>DRAWER</th><th>RACK</th><th>BOX POSITION</th><th>BOX LABEL</th><th>FREEZER POSITION</th><th>STATUS</th><th>LAB NO</th><th>TYPE</th><th>VOLUME</th>
		...
		<td>$status</td><td>$labno</td><td>$type</td><td>$volume</td>
