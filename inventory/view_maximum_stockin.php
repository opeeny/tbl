...
<div class="col-md-10">
 <div class="table-responsive">
     <div class="alert alert-info">
         ...
         <strong><i class="icon-user icon-large"></i>&nbsp;Maximum stock</strong>
     </div>
     <table cellpadding="3" cellspacing="3" border="0" class="table  table-bordered " id="example">
         <div class="pull-right">
             <a href="download_min.php"  class="btn btn-info"><i class="icon-download icon-large"></i>Download</a>
         </div>
         <thead>
         <tr>
             <th>S/N</th>
         ...
         include("../includes/dbconfig.php");
         $i =0;
         $user_query=mysqli_query($dbconnection,"select s.*,p.* from 
		 stock_sum s,products_list p  where  s.product_id=p.item_id 
		 and  p.maximum<=s.qty_bal")or die(mysql_error());
