 ...
 <div class="table-responsive">
     <table cellpadding="3" cellspacing="3" border="0" class="table  table-bordered" id="example">
         <div class="alert alert-info">
             ...
             <strong><i class="icon-user icon-large"></i>&nbsp;Pending Item Requests</strong>
         </div>
         <thead>
         <tr>
             <th>Request Date</th>
         ...
         <?php
         include("../includes/dbconfig.php");
         $user_query=mysqli_query($dbconnection,"select r.*,p.* from requests r INNER JOIN products_list p ON r.product_id=p.item_id  WHERE status='pending'")or die(mysqli_error($dbconnection));
         while($row=mysqli_fetch_array($user_query,MYSQLI_ASSOC))
         {
             ...
             <tr class="del<?php echo $id ?>">
                 ...
                 <td class="action" width="50">
                     <a  rel="tooltip"  title="Approve" id="e<?php echo $id; ?>" href="approve_request.php?approval=<?php echo $id; ?>" class="btn btn-default">Approve</a>
                 </td>
             </tr>
         <?php
         }  ?>
