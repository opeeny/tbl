    ...
    <div class="table-responsive">
     <div style="background-color:;">
         <form action="" method="POST">
             ...
             <input type="submit" name="submit" value="Generate a report" class="btn btn-success"/>
     ...
     <div id="divToPrint" >
         <table cellpadding="3" cellspacing="3" border="1" class="table  table-bordered">
             ...
             $user_query=mysqli_query($dbconnection,"select * from requests WHERE dor BETWEEN '$date_from' AND '$date_to'")or die(mysql_error($dbconnection));
