...
//INSERT INTO results_dst1_hist(name,sector,district,venue,start_date,end_date) SELECT Name,Sector,District,Venue,Start_Date,End_Date FROM tsd_program_temp
