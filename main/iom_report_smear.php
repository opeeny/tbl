...
<div class="col-sm-3"> 
    <input type="text" class="form-control" name="findlabno" placeholder="Search Patient" autofocus />
</div>
<div class="col-sm-1"> 
...
<div id="divToPrint" >
 <style type="text/css">
 <!--table hr{border:solid 2px black;}
 tr.smearhead{border-bottom:solid 3px black;}-->
 td{align:left;}
#resultsfooter{
...
.lefcontact2{margin-left:2%; margin-right:10%; float:right; font-size:16px; 
}
.title2{ font-size:19px;font-weight:800;		
				}
				 trm { bottom-border: 1px solid black !important;
 }

    @media print
    {hr{border:solid 2px black;}
tr.culturebold td{font-weight:700;
	}
.lefcontact1{margin-left:0%; float:left; font-size:16px; }
.lefcontact2{margin-left:2%; float:right; font-size:16px; 
}
...
<?php include("iomresults_show_simplified.php"); ?>
</div>
<?php
}
...
Print Date & Time: <?php date_default_timezone_set("Africa/Nairobi"); echo date('l, F d Y, h:i A'); ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br>
Results Authorised &nbsp;&nbsp;&nbsp;&nbsp;Sign:<sub>........................................................</sub>&nbsp;&nbsp;&nbsp;&nbsp; 
Date:<sub>.....................................</sub><br>

<sub>For questions concerning this report, Contact lab at <?php echo $reportcontact ?></sub>
<hr><div class="col-sm-6left" >
<b><u>
<?php echo "$l1 "?></u></b><br>
<?php echo "$l2 "?><br>
<?php echo "$l3 "?> <br>
...
<div style="text-align: right; width:100%; background-color:white;"><sup><i><b>Page 1 of 1</b></i></sup></div>
