...
if(isset($_GET['saverequester-success'])){
	echo "<font color='green'>Collector Registration was successful</font>";
}	
?>

<center><h4> <label class="label-format"> Collector Registration</label> </h4></center>
	...
	<div class="form-group"> 
      ...
      <div class="col-sm-4"> 
        <input type="text" class="form-control" placeholder="Enter Contact Information" name="contact" />
		  ...
		  <div class="col-sm-4"> 
        <button type="Submit" name="regcoll"  class="btn btn-primary">Submit</button>
      </div>
