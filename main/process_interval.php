...
if($interval === 'Month'){
	?>
      <div class='col-sm-5'>
        <label class="col-sm-1 control-label ">Month Choices : </label>
...
if($interval == 'Day'){
	?>
      <div class='col-sm-5'>
       <label class=" control-label label-format">Day Option : </label>
...
if($interval == 'Others'){
	?>
      <div class='col-sm-4'>
		...
		<div class='col-sm-8'>
		<input type="text" class="form-control" name="otheroption" placeholder="Start Typing for options"  list="otheroption" required/>
