...
<table width='90%'><tr>
<td align='left'><b>SPECIMEN RECORD</b></td><td align='center'><b><?php echo $laboratoryname; ?></b></td><td style="text-align: right;"><b>LAB NO <?php echo $studycode .'-'. $labno;?></b></td>
</tr></table>
<hr>
...
<tr valign='top'>
	<td colspan=''>Media:&emsp;&emsp;<?php echo $sample_media;?></td>
	<td colspan='2'>Request:&emsp;&emsp;<?php echo $examination;?></td>
</tr>
</table>
...
<tr>
	<td>Tech/Date</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>
	<td>Tech/Date</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>
</tr>
</table>
...
<span style="background-color:#CCCCCC;"><b>LIQUID CULTURE</b></span>
<table class="table-condensed" border='1'>
<tr><td>For (Media)</td>
...
<span style="background-color:#CCCCCC;"><b>SOLID CULTURE</b></span>
...
<span style="background-color:#CCCCCC;"><b>BLOOD CULTURE</b></span>
...
<span style="background-color:#CCCCCC;"><b>IDENTIFICATION FOR CULTURE</b></span>
...
<span style="background-color:#CCCCCC;"><b>GENEXPERT</b></span>
<table class="table-condensed" border='1'>
...
if($dst1count>0){ ?>
<span style="background-color:#CCCCCC;"><b>1st LINE DST RESULTS</b></span>
		...
		?>
		<table class="table-condensed" border='1'>
		<tr><td colspan='5'>Method/Tech/Date: </td></tr>
		<?php
...
if($dst2count>0){ ?>
<span style="background-color:#CCCCCC;"><b>2nd LINE DST RESULTS</b></span>
...
<span style="background-color:#CCCCCC;"><b>OTHER RESULTS</b></span>
