...
<div class="col-md-3 col-sm-6 col-xs-6">           
	...
	<div class="text-box" >
		...
		<select name="result"  class="form-control" onchange="location = this.value;">
			...
			<option value='samples_edit.php' style='background-color:#CCCCCC;'>Samples Data Update</option>
	...
	<div class="text-box" <?php if($role=='Lab Technologist' or $role=='Data Administrator'){ ?>style='pointer-events:none;' <?php } ?> >
		...
		<?php
			...
			while ($othertest = mysqli_fetch_array($othertests,MYSQLI_ASSOC)) {
				$code = $othertest['code'];
				$name = $othertest['name'];
				echo "<option value='resultsreview_others.php?newtest=$code' style='background-color:#CCCCCC;'>
				OTHERS - $name</option>";
			}
			?><option value='questioned' style='background-color:#CCCCCC;'>Questioned Results</option>
		<!--
			
			<option value='ID' style='background-color:#CCCCCC;'>IDENTIFICATION </option>
				-->
			</select>
		<p class="text-muted"></p>
	</div>
	...
	<span class="icon-box bg-color-green set-icon"> <i class="glyphicon glyphicon-level-up"></i> </span>
	<div class="text-box" >
		<p class="main-text">Results Update</p>
			
			<!--<select name="result"  class="form-control" onchange="redirecttoresultsentry(this.value);">
			<option value="">Select a Test for Results Entry</option>
			<option value='FM' style='background-color:#CCCCCC;'>MICROSCOPY - FM (Concentrated)</option>
		    <option value='ZN' style='background-color:#CCCCCC;'>MICROSCOPY - ZN (Concentrated)</option>
			<option value='GENEXPERT' style='background-color:#CCCCCC;'>GENEXPERT</option>
			<option value='LC' style='background-color:#CCCCCC;'>LIQUID CULTURE </option>
			<option value='SC' style='background-color:#CCCCCC;'>SOLID CULTURE </option>
			<option value='BC' style='background-color:#CCCCCC;'>BLOOD CULTURE </option>
			<option value='ID' style='background-color:#CCCCCC;'>IDENTIFICATION </option>
			<option value='dst1' style='background-color:#CCCCCC;'>1st LINE DST</option>
			<option value='dst2' style='background-color:#CCCCCC;'>2nd LINE DST</option>
			<option value='others' style='background-color:#CCCCCC;'>OTHERS</option>
			</select>-->
			
			<select name="result"  class="form-control" onchange="location = this.value;">
			<option value="">Select a Test for Results Update</option>
			<option value='resultsentry_fm.php?update=yes' style='background-color:#CCCCCC;'>MICROSCOPY - FM (Concentrated)</option>
		    <option value='resultsentry_zn.php?update=yes' style='background-color:#CCCCCC;'>MICROSCOPY - ZN (Concentrated)</option>
			<option value='resultsentry_genexpert.php?update=yes' style='background-color:#CCCCCC;'>GENEXPERT</option>
			<option value='resultsentry_liquidculture.php?update=yes' style='background-color:#CCCCCC;'>LIQUID CULTURE </option>
			<option value='resultsentry_solidculture.php?update=yes' style='background-color:#CCCCCC;'>SOLID CULTURE </option>
			<option value='resultsentry_bloodculture.php?update=yes' style='background-color:#CCCCCC;'>BLOOD CULTURE </option>
			<option value='resultsentry_identification.php?update=yes' style='background-color:#CCCCCC;'>IDENTIFICATION </option>
			<option value='resultsentry_dst1.php?update=yes' style='background-color:#CCCCCC;'>1st LINE DST</option>
			<option value='resultsentry_dst2.php?update=yes' style='background-color:#CCCCCC;'>2nd LINE DST</option>
			<option value='' style='background-color:#CCCCCC;'>OTHERS</option>
			<?php
			include("../includes/dbconfig.php");
			$sql="SELECT * FROM option_examination_others WHERE status='Active'";
			...
			while ($othertest = mysqli_fetch_array($othertests,MYSQLI_ASSOC)) {
				$code = $othertest['code'];
				$name = $othertest['name'];
				echo "<option value='resultsentry_others.php?update=yes&&newtest=$code' style='background-color:#CCCCCC;'>
				OTHERS - $name</option>";
			}
			?>
			</select>
...
<div class="row">
	...
	<span class="icon-box bg-color-green set-icon"> <i class="fa fa-lock"></i> </span>
		<div class="text-box" >
			<button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal"><p class="main-text">Change Password</p></button>
		  <!-- Modal -->
	...
	<div class="text-box" >
		...
		<select name="result"  class="form-control" onchange="location = this.value;">
			<option value="">Select an Admin task</option>
			<option value='admin_study.php' style='background-color:#CCCCCC;'>Manage Studies/Projects</option>
			<option value='admin_resinterpret.php' style='background-color:#CCCCCC;'>Manage Results Interpretation</option>
	...
	<span class="icon-box bg-color-green set-icon"> <i class="glyphicon glyphicon-stats"></i> </span>
	<div class="text-box" <?php if($role=='Quality Officer' or $role=='Lab Technologist'){ ?>style='pointer-events:none;' <?php } ?>>
...
<div class="col-md-3 col-sm-6 col-xs-6">           
	...
	<div class="text-box" <?php if($role=='Lab Technologist' or $role=='Data Administrator'){ ?>style='pointer-events:none;' <?php } ?> >
		<p class="main-text">Advanced Settings</p>
			...
			<option value='iom_culture_results.php' style='background-color:#CCCCCC;'>IOM Culture Report</option>
			<option value='singlepagereport_soft.php' style='background-color:#CCCCCC;'>Single Page Results Report</option>
			
			<option value='admin_users.php' style='background-color:#CCCCCC;'>Manage Users</option>
			<option value='userlogreport_select.php' style='background-color:#CCCCCC;'>User Log Report</option>
		    
		<option value='admin_report.php' style='background-color:#CCCCCC;'>Report Settings</option>
			...
			<option value='contactsettings.php' style='background-color:#CCCCCC;'>Footer Contact Settings</option>
			 <option value='reporttitlesetting.php' style='background-color:#CCCCCC;'>Report Title Settings</option>
			<option value='report_soft_simplified.php?state=corrected' style='background-color:#CCCCCC;'>Print Corrected Reports</option>
			<option value='report_soft_simplified.php?state=reprint' style='background-color:#CCCCCC;'>Re-Print Results Reports</option>
			<option value='audit_search.php' style='background-color:#CCCCCC;'>Results Audit Search</option>
			<option value='results_audit_advanced.php' style='background-color:#CCCCCC;'>Summary Results Audit</option>
		</select>
		<p class="text-muted"></p>
	</div>
	...
	<div class="text-box" <?php if($role=='Lab Technologist' or $role=='Data Administrator'){ ?>style='pointer-events:none;' <?php } ?> >
		<p class="main-text">QC Management</p>
			...
			<select name="result"  class="form-control" onchange="redirecttoqc(this.value);">
			...
			<option value='phos' style='background-color:#CCCCCC;'>PHOSPHATE BUFFER QC</option> 
		     <option value='7h10s' style='background-color:#CCCCCC;'>7H10/11,7H10/11S& 7H10/11S+ QC</option> 
		<!--
