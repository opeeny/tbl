...
<div class="title3" style="background-color:white; width=100%; font-size:;  margin:; padding-left:;"><center><b><?php if($reportstatus=='Preliminary'){ echo "PRELIMINARY  ";}else{
	echo "FINAL ";
} ?>LABORATORY RESULTS REPORT</b> &emsp;&emsp;&emsp;LAB No: <b><?php 
...
<tr valign='top'>
	...
	<?php if($name!='NP' or $name!='Not Provided'){ ?><b><br>Patient Name:&emsp;<?php echo $name; }?></b>
...
<table class="table table-condensed">
<tr><td>Media</td><td>Days to Positive</td><td>ZN Culture</td><td>BAP</td><td>Result</td><td>Date</td></tr>
