...
<div class="report-title" style="background-color:white; width=100%;"><center>
<b class="title1">
...
<table width='100%'><tr>
	...
	<?php if($state=='normal'){?>
		<b>
			<?php if($reportstatus=='Preliminary'){ echo "PRELIMINARY  ";}else{ echo "FINAL ";} ?>
	LABORATORY RESULTS REPORT</b>
	<?php } 
	if($state=='reprint'){?>
	<b>
	REPRINTED 
	...
	<b class="contact">LAB No: <?php
	if($studycode=='BDM'){echo $labno;}else {echo $studycode .'-'. $labno; }?></b>
	</td>
</tr></table>
<hr style='border-width: 3px; border: 1px solid black;'>
</div>
...
<div style="width:100%;">
<div class="lefcontact1" style="width:100%;"><b class="contact">
<?php if($studycode=='PV'){ ?>
...
<tr valign='top'>
	...
	<td>Visit Interval:&emsp;<b><?php echo $interval;?></b></td>
</tr>
<tr>
...
//CHECKING OPTIONAL FIELDS ENDS HERE
...
<?php if($showdtp=='Show'){ ?><td>Days To Positive</td><?php } ?>
<?php if($showbap=='Show'){ ?><td>BAP</td><?php } ?>
<?php if($showznc=='Show'){ ?><td>ZN Culture</td><?php } ?>
<td>Result</td>
<td>Result Date</td><?php if($showtech=='Show'){ ?><td>Tech</td><?php } ?></tr>
	...
	<?php if($showbap=='Show'){ ?><td><?php echo $liquidculture_resbap;?></td><?php }?>
	<?php if($showznc=='Show'){ ?><td><?php echo $liquidculture_resznc;?></td><?php }?>
...
<table class="table table-condensed">
<tr class="boldhead"><td>Media</td>
<?php if($showsqt=='Show'){ ?><td>Semi Quantitative</td> <?php } ?>
<?php if($showqt=='Show'){ ?><td>Quantitative</td> <?php } ?>
<?php if($showsql=='Show'){ ?><td>Qualitative</td> <?php } ?>
<td>Result</td>
<td>Result Date</td>
...
while ($solidculture= mysqli_fetch_array($solidcultures,MYSQLI_ASSOC)) {
		...
		<?php if($showsqt=='Show'){ ?><td><?php echo $solidculture_ressqt;?></td>
		<?php } ?>
		<?php if($showqt=='Show'){ ?><td><?php echo $solidculture_resqt;?></td>
		<?php } ?>
		<?php if($showsql=='Show'){ ?><td><?php echo $solidculture_ressql;?></td>
		<?php } ?>
		<td><?php echo $solidculture_interpretation;?></td>
		<td><?php echo $solidculture_resdate?></td>
		<?php if($showtech=='Show'){ ?><td>
		<?php echo $solidtech; ?></td> <?php } ?>
...
<table class="table table-condensed">
<tr class="boldhead"><td>Culture/Media</td><td>Method</td><td>Result</td><td>Result Date</td>
<?php if($showtech=='Show'){ ?><td>Tech</td><?php } ?></tr>
...
<?php if($dst1count2>0){?>	
		...
		?>
		Method: <?php echo "<b>$dst1method ($dst1methodtype)</b>"; ?> &nbsp;&nbsp; Results Date: <?php echo $dst1resdate; ?> 
		...
		if($dst1[$drugcolumn] != ''){ echo "$name - <b>$dst1[$drugcolumn]</b> <br>"; }
		}
	//	echo "<br>";
		}
}
...
<?php if($dst2count2>0){?>	
		...
		?>
		Method: <?php echo "<b>$dst2method ($dst2methodtype)</b>"; ?> &nbsp;&nbsp; Results Date: <?php echo $dst2resdate; ?> 
		...
		if($dst2[$drugcolumn] != ''){ echo "$name - <b>$dst2[$drugcolumn]</b> <br>"; }
		}
	//	echo "<br>";
		}
}
...
if($othersresult_count>0){ echo "<hr>";?>

<b>OTHER RESULTS</b>

<?php if($othersresult_count2>0){?>
<table class="table table-condensed">
<tr class="boldhead"><td>Examination</td><td>Result</td><td>Result Date</td></tr>
...
<div style="text-align: right; width:100%;"><br><sup><i><b>Page 1 of 2</b></i></sup></div>
</div>
