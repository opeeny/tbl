...
<b class="title1"><?php echo $reporttitle1 ?>
<?php if($reporttitle2!=''){echo "<br>$reporttitle2 "; }?>
<!--MAKERERE UNIVERSITY DEPARTMENT OF MEDICAL MICROBIOLOGY 
MYCOBACTERIOLOGY (BSL-3) LABORATORY--></b> 
<BR>


</center></div>

<div class="title3" style="background-color:white; width=100%; font-size:;  margin:; padding-left:;"><center><b>
CORRECTED LABORATORY RESULTS REPORT </b> &emsp;&emsp;&emsp;LAB No: <b><?php 
...
<tr valign='top'>
	...
	Collection Method:&emsp;<?php echo $collmtd;?><br>
...
<tr>
<td style="min-width:110px">Concentrated FM</td>
...
else echo "Concentrated FM is pending";
}
?>
<?php if($dfmcount>0){?>
...
<?php if(@$dfmreviewstatus){ echo "<font color='red'>  >>Results Entry was not Reviewed</font>";}?></td>
</tr>
<?php 
}
...
<table class="table table-condensed">
<tr><td>Media</td><td>Result<?php if($showsolid!='Hidden'){ ?><td>Days To Positive</td><?php } ?></td><td>Date</td></tr>
	...
	<?php if($showsliquid!='Hidden'){ ?><td><?php echo $liquidculture_resdtp;?></td> <?php } ?>
...
<table class="table table-condensed">
<tr><td>Media</td><td>Result</td>
<?php if($showsolid!='Hidden'){ ?><td>Semi Quantitative</td> <?php } ?><td>Date</td></tr>
...
while ($culture_interpretation = mysqli_fetch_array($culture_interpretations,MYSQLI_ASSOC)) {
		...
		<?php if($showsolid!='Hidden'){ ?><td><?php echo $solidculture_ressqt;?></td><?php } ?>
...
<table class="table table-condensed">
<tr><td>Media</td><td>Result</td><td>Date</td></tr>
...
For Questions Concerning this report,Contact lab on <?php echo $reportcontact ?>
