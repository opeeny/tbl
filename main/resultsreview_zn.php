...
$sql = "UPDATE results_zn SET reviewer='$reviewer',rejreason='$rejreason',reviewdate='$reviewdate', status='Rejected' WHERE labno=$reslabno";
mysqli_query($dbconnection,$sql) or die("ERROR : " . mysqli_error($dbconnection));
$sql = "INSERT into results_rejections (rejreason,labno,entrant,test,reviewer)  values('$rejreason','$reslabno','$entrant','Microscopy_ZN','$reviewer')";
...
$sql = "UPDATE results_zn SET reviewer='$reviewer',status='Accepted',reviewdate='$reviewdate' WHERE labno=$reslabno";
mysqli_query($dbconnection,$sql) or die("ERROR : " . mysqli_error($dbconnection));
...
location.href='resultsreview_zn.php'
</script> ";
}
...
?>
<div class="col-md-7">
<fieldset class="scheduler-border"><legend  class="scheduler-border" ><b>MICROSCOPY -ZN  RESULTS REVIEW- SAMPLE SEARCH</b></legend>
...
<div class="col-md-3">
<input type="button" value="<<PREVIOUS" class="form-control btn-success" onclick="location.href='resultsreview_zn.php?findlabno=<?php echo @$prevlabno;?>'">
</div>
<div class="col-md-2">
<input type="button" value="NEXT>>" class="form-control btn-info" onclick="location.href='resultsreview_zn.php?findlabno=<?php echo @$nextlabno;?>'">
</div>
</div>
</div></form>
</fieldset>
...
<?php }?>
		 ...
		 <div class="col-sm-3"> 
<input type="submit" class="btn btn-success" name="ressubmit_zn" <?php if($status=='Accepted'){?>value="RESULT PASSED REVIEW"<?php }
...
<?php
include("../includes/dbconfig.php");
$sql="SELECT * FROM results_zn WHERE result!=''  and status=''";
...
<b>PENDING MICROSCOPY ZN RESULTS REVIEW</b><br>
This is a list of pending MICROSCOPY ZN results Review. [TOTAL = <?php echo $totalempty;?>]<br>
