...
echo "<div id='successmessage'>
 <center>Sample $deleted - $scode deletion was successful!</div>";
}
...
?><fieldset class="scheduler-border"> <legend  class="scheduler-border"><b>SEARCHING SAMPLE FOR DELETING</b></legend>
