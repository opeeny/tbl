<div class="form-group"> 
	 ...
	 <?php
			...
			while ($appearance = mysqli_fetch_array($appearances_check,MYSQLI_ASSOC)) {
				...
				$name = $appearance['name'];
					...
					$resultstable='results_'.$code;
					$testcheckpresence=mysqli_query($dbconnection,"SELECT * FROM $resultstable WHERE labno=$labno") or die("ERROR : " . mysqli_error($dbconnection));
	...
	<?php
			...
			while ($othertest = mysqli_fetch_array($othertests,MYSQLI_ASSOC)) {
				...
				$testcheckpresence=mysqli_query($dbconnection,"SELECT * FROM $resultstable WHERE labno=$labno and test='$code'") or die("ERROR : " . mysqli_error($dbconnection));
				$testcount=mysqli_num_rows($testcheckpresence);
	...
	<?php
			...
			$storages=mysqli_query($dbconnection,$sql) or die("ERROR : " . mysqli_error($dbconnection));
    ...
    <?php
			...
			while ($solidmedia = mysqli_fetch_array($solidmedias,MYSQLI_ASSOC)) {
				...
				$testcheckpresence=mysqli_query($dbconnection,"SELECT * FROM $resultstable WHERE labno=$labno AND media='$code'") or die("ERROR : " . mysqli_error($dbconnection));
				$testcount=mysqli_num_rows($testcheckpresence);
