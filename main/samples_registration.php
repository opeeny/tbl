...
if(isset($_POST['Submit'])){
	...
	@$storage=mysqli_real_escape_string($dbconnection,implode(',', $_POST['storage']));
	@$fullexamination=$examination.','.$otherexamination.','.$storage;
	//@$fullexamination = implode(",", array_merge($examination,$otherexamination));
	
	print_r(array_merge($examination,$otherexamination,$storage));
...
//echo "<h2>Visit Interval is $interval</h2>";
...
<div class="form-group">
	...
	<label class="col-sm-1 control-label label-format">Sample Hierachy</label>
      <div class="col-sm-3"> 
	  <input type="text" class="form-control" name="sample_hierachy" placeholder="Start Typing for options" list="sample_hierachy"/>
	...
	<option value="N/A" class="form-control" >N/A</option>
      ...
      <div class="col-sm-2"> 
	   <input type="text" class="form-control" name="specimen_type" placeholder="Start Typing for options" list="specimen_type" required/>
 <datalist id="specimen_type" >
        <select name="specimen_type_option" class="form-control" >
...
<div class="col-sm-2">
	  ...
	  <!--<input type="text" class="form-control" name="visit_interval" placeholder="Start Typing for options"  list="visit_interval" required/>
 <datalist id="visit_interval">
	   <select class="form-control" name="visit_interval_option"  >
			...
			echo "<option value='$code' style='background-color:#CCCCCC;'>$name</option>";	
			}			
			?>
		</select>
		</datalist>-->
...
<div class="col-sm-3"> 
<input type="text" class="form-control" placeholder="Start Typing for options" 
name="appearance" list="appearance"/>
 <datalist id="appearance">
	  <select name="appearance_option" class="form-control"  onclick="" id="collectorsearch">
		
       
                <select name="appearance_option" class="form-control" >
