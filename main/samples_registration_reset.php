...
if(isset($_POST['Submit'])){
	...
	/*if($recieved_date==''){ echo "<h2>Received Date is Mnadatory</h2>";
	exit();
...
$insertsql="insert into samples (inoculationdate,inoculationtime,sample_id,accessiontech,studycode,patient,ageyears,agemonths,visitinterval,
...
media,specstorage,comment,transporter,processtime,processdate,processtech,transporttime,transportdate)
		values ('$innoc_date','$innoc_time','$sampleid','$accessionedby','$s_code','$pauto_id','$years','$months','$visit_interval','$sample_hierachy','$request_reason','$specimen_type',
...
<form action="" method="POST" name="regform" id="example-1-form" autocomplete="off" onmsubmit="return validateForm()" >
...
<div class="form-group">
	...
	<label class="col-sm-1 control-label label-format">PID<?php echo'<font color="#FF0000">'. "***".'</font>';?></label>
    <div class="col-sm-3"> 
	...
	<option value="" class="form-control" >N/A</option>
      ...
      <label class="col-sm-1 control-label label-format">Specimen Type<?php echo'<font color="#FF0000">'. "***".'</font>';?></label>
      <div class="col-sm-2"> 
        <select name="specimen_type" class="form-control" required>
	...
	<div class="form-group"> 
      <label class="col-sm-1 control-label label-format">Visit Interval<?php echo'<font color="#FF0000">'. "***".'</font>';?></label>
      <div class="col-sm-3"> 
	   <select class="form-control" name="visit_interval" required >
      ...
      <div class="col-sm-2"> 
		...
		"class="form-control" placeholder="" name="years"/>
      </div>
...
<label for="dtp_input3" class="col-sm-2 control-label label-format">Collection Time</label>
	  <div class="col-sm-2"> 
	<!--	<input type="text" class="form-control time_picker" name="collection_time" pattern="^([0-1]?[0-9]|2[0-3]):[0-5][0-9]$" placeholder="hh:mm (24hr format)" />
 ...
 <div class="form-group"> 
      ...
      <div class="col-sm-3"> 
	  <input type="text" name="months" style="color: #222;" class="form-control" placeholder="" />     
      </div>
	  ...
	  <div class="col-sm-2"> 
		<input type="text" class="form-control" name="transport_time" pattern="^([0-1]?[0-9]|2[0-3]):[0-5][0-9]$" placeholder="hh:mm (24hr format)" />
	</div>
	...
	<div class="form-group"> 
      <label class="col-sm-1 control-label label-format">Received Date<?php echo'<font color="#FF0000">'. "***".'</font>';?></label>
	  <div class="col-sm-3"> 
	...
	<label  class="col-sm-2 control-label label-format">Received Time<?php echo'<font color="#FF0000">'. "***".'</font>';?></label>
	<div class="col-sm-2"> 
		<input type="text" class="form-control" required name="recieved_time" pattern="^([0-1]?[0-9]|2[0-3]):[0-5][0-9]$" placeholder="hh:mm (24hr format)" />
	</div>
	...
	<label class="col-sm-1 control-label label-format">Appearance</label>
      ...
      <div class="col-sm-3"> 
        <input type="text" style="color: #222;
		"class="form-control" placeholder="Volume" name="volume" width="10%" />
      </div>
...
text-transform: capitalize;"class="form-control" placeholder="Consistency" name="consistency" />
	...
	<div class="form-group"> 
     <label class="col-sm-1 control-label label-format">Processing Date<?php echo'<font color="#FF0000">'. "***".'</font>';?></label>
	  <div class="col-sm-3"> 
...
=======
	  ...
	  <div class="col-sm-3"> 
		<input type="text" class="form-control" name="process_time" pattern="^([0-1]?[0-9]|2[0-3]):[0-5][0-9]$" placeholder="hh:mm (24hr format)" />
	</div>
>>>>>>> origin/master
	...
	<label  class="col-sm-2 control-label label-format">Processing Technologist</label>
	 ...
	 <div class="form-group"> 
	 <label class="col-sm-1 control-label label-format">Inoculation Date</label>
      <div class="col-sm-3"> 
	  <div class="input-group date form_date col-md-12" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input14" data-link-format="yyyy-mm-dd">
                    <input class="form-control" size="16" type="text" value="" readonly>
                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
				...
				<input type="hidden" id="dtp_input14" value="" name="innoc_date" />
				</div>
	  <label class="col-sm-2 control-label label-format">Inoculation Time</label>
	  <div class="col-sm-2"> 
		<input type="text" class="form-control" name="innoc_time" pattern="^([0-1]?[0-9]|2[0-3]):[0-5][0-9]$" placeholder="hh:mm (24hr format)" />
	</div>
...
text-transform: capitalize;"class="form-control" placeholder="Comment" name="comment" />
	...
	<div class="form-group">
	<label class="col-sm-2 control-label label-format">Confirm Completeness<?php echo'<font color="#FF0000">'. "***".'</font>';?></label>
    <div class="col-sm-6"> 
