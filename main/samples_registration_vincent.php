...
<label for="dtp_input3" class="col-sm-2 control-label label-format">Collection Time</label>
 ...
 <div class="form-group"> 
	...
	<div class="col-sm-2"> 
		<input type="text" class="form-control defaultEntry" required name="recieved_time"  />
	</div>
...
text-transform: capitalize;"class="form-control" placeholder="Consistency" name="consistency" />
	...
	<div class="form-group"> 
	 ...
	 <label class="col-sm-1 control-label label-format">Inoculation Date</label>
	  ...
	  <div class="col-sm-2"> 
		<!--<input type="text" class="form-control" name="innoc_time"  />-->
		 <input type="text" class="form-control defaultEntry" name="innoc_time" size="">
	</div>
