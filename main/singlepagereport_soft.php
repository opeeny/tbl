...
.lefcontact1{margin-left:0%; float:left; font-size:16px;font-weight:700; }
.lefcontact2{margin-left:2%; margin-right:10%; float:right;font-weight:700;
 font-size:19px; 
}
...
.lefcontact2{margin-left:2%; float:right; font-size:18px; 
}
...
div#format-print{font-family:Arial Narrow,Arial,sans-serif; font-size:0.8em; }

 .smallfont td{font-family:Arial Narrow,Arial,sans-serif; font-size:0.9em;}
 .table th, 
...
<?php include("singlepagereport_show.php"); ?>
</div>
<?php
}
