...
SEARCHING FREEZER STORAGE RECORDS ARCHIEVE<hr>

<div class="col-sm-6 row"> 
	<div class="form-horizontal">
	<form action="" method="GET" name="" onsubmit="" autocomplete="off">
...
include("../includes/dbconfig.php");
	...
	if(isset($_GET['labno'])){
	$labno=$_GET['labno'];
	$searchs=mysqli_query($dbconnection,"SELECT s.*,c.* FROM samples s,storage_records_hist c 
