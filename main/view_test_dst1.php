...
$sqlvalue= "SELECT r.*,s.processdate,s.studycode,s.rctdate from results_dst1 r ,
...
$methodvalues = mysql_query("SELECT DISTINCT method from results_dst1 order by id") or die("ERROR : " . mysql_error());
...
$sqlvalue= "SELECT labno, count(*) dst1_methods";
...
while ($methodvalue = mysql_fetch_array($methodvalues)){
    ...
    $dst1 = mysql_query("SELECT * from results_dst1") or die("ERROR : " . mysql_error());
...
$create_view_sql = "CREATE VIEW tblis_jcrc.results_dst1_view AS $sqlvalue";
