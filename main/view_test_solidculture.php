...
$sqlvalue= "SELECT r.*,s.processdate,s.studycode,s.rctdate from results_solidculture r ,
...
$mediavalues = mysql_query("SELECT DISTINCT media from results_solidculture order by id") or die("ERROR : " . mysql_error());
...
$sqlvalue= "SELECT labno, count(*) CS_media";
...
$sqlvalue = $sqlvalue . "
 FROM 
    results_solidculture 
GROUP BY 
    labno";

echo $sqlvalue;

$create_view_sql = "CREATE VIEW tblis_jcrc.results_solidculture_view AS $sqlvalue";
...
$mediavalues = mysql_query("SELECT DISTINCT media from results_solidculture") or die("ERROR : " . mysql_error());
