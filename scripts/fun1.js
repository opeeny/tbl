...
if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
    document.getElementById("collectorssearch").innerHTML=xmlhttp.responseText;
    }
}  
    xmlhttp.open("GET","../main/ajax_reload_collectors.php",true);
	xmlhttp.send();
}
...
if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
    document.getElementById("transporterssearch").innerHTML=xmlhttp.responseText;
    }
}  
    xmlhttp.open("GET","../main/ajax_reload_transporters.php",true);
	xmlhttp.send();
}